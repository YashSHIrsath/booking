        ...
        <div class="display-info" style="padding-top : 100px">
            <div class="intro-info">
                <div class="image-info">
                    <img  src="images/new posters/maidaan-et00109952-1712742201.webp" alt="">
                </div>
                <div class="information">
                    <div class="part1">
                        <h2 id="header">Maidaan</h2>
                        <p id="cost">240 Rs</p>
                        <p>3h 1m • Biography, Drama, Sports • UA • 10 Apr, 2024</p>
                        <p> हिन्दी English (2D, ICE, IMAX 2D)</p>
                        <div class="timings">
                            <span style="font-size: 11px;">Timings : </span>
                            <span style="font-size: 10px;" id="timings1">10:30 AM,</span>
                            <span style="font-size: 10px;" id="timings2">2:30 PM,</span>
            ...
            <div class="about-section">
                <h1>About</h1>
                <p>
                    A journey undertaken by a single man over a span of 10 years in the pursuit of making a name for the nation.<br><br>
    
                    `Maidaan`, a true story of India`s greatest football coach, Syed Abdul Rahim -a story of the Golden Era of Indian Football,<br> a story of true grit and unfathomable passion.
                </p>
            </div>
            ...
            <div class="cast-crew">
                ...
                <div class="cast">
                    <div class="cast-info">
                        <img src="images/cast/ajay-devgn-24051-12-09-2017-04-41-13.webp" alt=""> 
                        <h3>Ajay Devgan</h3>  
                    </div>
                    <div class="cast-info">
                        <img src="images/cast/priyamani-1738-1654347025.webp" alt="">
                        <h3>Priyamani</h3> 
                    </div>
                    <div class="cast-info">     
                        <img src="images/cast/gajraj-rao-703-16-12-2020-04-53-14.webp" alt="">
                        <h3>Gajraj Rao</h3> 
                    </div>
                    <div class="cast-info">
                        <img src="images/cast/rudranil-ghosh-6521-24-03-2017-17-49-57.webp" alt="">
                        <h3>Rudranil Ghosh</h3> 
                    </div>
                </div>
                <h1 class="crew-heading">Crew</h1>
                <div class="crew">
                    <div class="crew-info">
                        <img src="images/crew/arunava-joy-sengupta-2035126-1709991695.webp" alt=""> 
                        <h3>Arunava Sengupta</h3>  
                        <p class="post">Director</p>
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/boney-kapoor-iein002555-24-03-2017-12-44-05.webp" alt="">
                        <h3>Boney Kapoor</h3> 
                        <p class="post">Producer</p>
                    </div>
                    <div class="crew-info">     
                        <img src="images/crew/zee-studios-1090737-11-06-2018-04-13-39.webp" alt="">
                        <h3>Zee Studios</h3> 
                        <p class="post">Producer</p>
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/amit-ravindernath-sharma-1052017-24-03-2017-17-37-54.webp" alt="">
                        <h3>Amit Sharma</h3> 
                        <p class="post">Producer/Writter</p>
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/saiwyn-quadras-1046961-27-03-2018-04-11-54.webp" alt="">
                        <h3>Saiwyn Quadras</h3> 
                        <p class="post">ScreenPlay</p>
    
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/a_r_rahman_38.webp" alt="">
                        <h3>A R Rehmann</h3> 
                        <p class="post">Background Score</p>
    
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/manoj-muntashir-iein009648-24-03-2017-14-13-00.webp" alt="">
                        <h3>Manoj</h3> 
                        <p class="post">Lyricist</p>
