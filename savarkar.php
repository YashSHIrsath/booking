        ...
        <div class="display-info" style="padding-top : 100px">
            <div class="intro-info">
                <div class="image-info">
                    <img  src="images/new posters/Savarkar.webp" alt="">
                </div>
                <div class="information">
                    <div class="part1">
                        <h2 id="header">Savarkar</h2>
                        <p id="cost">180 Rs</p>
                        <p>2h 58m • Biography, Drama • UA • 22 Mar, 2024</p>
                        <p> हिन्दी English (2D, ICE)</p>
                        <div class="timings">
                            <span style="font-size: 11px;">Timings : </span>
                            <span style="font-size: 10px;" id="timings1">10:30 AM,</span>
                            <span style="font-size: 10px;" id="timings2">12:30 PM,</span>
                            <span style="font-size: 10px;" id="timings3">4:00 PM</span>
                        </div>
                    </div>
                    <div class="part2">
            ...
            <div class="about-section">
                <h1>About</h1>
                <p>
                    The British termed him the most dangerous man while Indian revolutionaries revered him as "Veer"!<br><br>
            ...
            <div class="cast-crew">
                ...
                <div class="cast">
                    <div class="cast-info">
                        <img src="images/cast/randeep-hooda-1827-24-03-2017-13-57-50.webp" alt=""> 
                        <h3>Randeep Hooda</h3>  
                        <p style="font-size: 10px; color: grey;">as Vinayak Damodar Savarkar</p>
                    </div>
                    <div class="cast-info">
                        <img src="images/cast/ankita-lokhande-1085565-22-09-2017-11-41-21.webp" alt="">
                        <h3>Ankita Lokhande</h3> 
                        <p style="font-size: 10px; color: grey;">as Yamuna Bai</p>
                    </div>
                    <div class="cast-info">     
                        <img src="images/cast/amit-sial-5903-24-03-2017-15-47-16.webp" alt="">
                        <h3>Amit Sial</h3> 
                        <p style="font-size: 10px; color: grey;">Actor</p>
                    </div>
                    <div class="cast-info">
                        <img src="images/cast/rajesh-khera-1791-1709626576.webp" alt="">
                        <h3>Rajesh Khera</h3> 
                        <p style="font-size: 10px; color: grey;">Actor</p>
                    </div>
                </div>
                ...
                <div class="crew">
                    <div class="crew-info">
                        <img src="images/crew/savarkar/randeep-hooda-1827-24-03-2017-13-57-50.webp" alt=""> 
                        <h3>Randeep Hooda</h3>  
                        <p style="font-size: 10px; color: grey;" class="post">Director,Producer</p>
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/savarkar/zee-studios-1090737-11-06-2018-04-13-39.webp" alt="">
                        <h3>Zee Studios</h3> 
                        <p style="font-size: 10px; color: grey;" class="post">Producer</p>
                    </div>
                    <div class="crew-info">     
                        <img src="images/crew/savarkar/anand-pandit-iein040671-28-04-2017-11-57-09.webp" alt="">
                        <h3>Anand Pandit</h3> 
                        <p style="font-size: 10px; color: grey;" class="post">Producer</p>
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/savarkar/sandeep-singh-2034426-1708072986.webp" alt="">
                        <h3>Sandeep Singh</h3> 
                        <p style="font-size: 10px; color: grey;" class="post">Producer/Writter</p>
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/savarkar/yogesh-rahar-2035881-1711944842.webp" alt="">
                        <h3>Yogesh Rahar</h3> 
                        <p style="font-size: 10px; color: grey;" class="post">ScreenPlay</p>
    
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/savarkar/utkarsh-naithani-1084917-1707466412.webp" alt="">
                        <h3>Utkarsh Naithani</h3> 
                        <p style="font-size: 10px; color: grey;" class="post">Dialogue Writer</p>
    
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/savarkar/vipin-patwa-26438-24-03-2017-14-59-08.webp" alt="">
                        <h3>Vipin Patwa</h3> 
                        <p style="font-size: 10px; color: grey;" class="post">Musician</p>
                    </div>
                    <div class="crew-info">
                        <img src="images/crew/savarkar/arvind-krishna-20411-03-07-2017-23-42-49.webp" alt="">
                        <h3>Arvind Krishna</h3> 
                        <p style="font-size: 10px; color: grey;" class="post">Cinematographer</p>
                    </div>
                </div>
            </div>
        </div>
