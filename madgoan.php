        ...
        <div class="display-info" style="padding-top : 100px">
            <div class="intro-info">
                <div class="image-info">
                    <img  src="images/new posters/madgoan.jpg" alt="">
                </div>
                <div class="information">
                    <div class="part1">
                        <h2 id="header">Madgoan Express</h2>
                        <p id="cost">300 Rs</p>
                        <p>2h 25m • Drama Comedy • UA </p>
                        <p> हिन्दी English (3D)</p>
                        <p style="margin: 10px 0px;"><b>Release Date</b> :  22 June, 2024</p>
                        
                        
                    </div>
                    <div class="part2">
                        <a href="https://youtu.be/B7VP47oCZfE?si=a1HWtUTy6HgBm7OX"><button id="submit">Watch trailer</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="cast-crew">
                ...
                <div class="cast">
                    <div class="cast-info">
                        <img src="images/cast/madgoan/Divyendu-sharma.avif" alt=""> 
                        <h3>Divyanshu Sharma</h3>  
                        <p style="font-size: 10px; color: grey;">Actress</p>
                    </div>
                    <div class="cast-info">
                        <img src="images/cast/madgoan/Nora-Fatehi-9-4ae82dc0-4ec4-11ed-af77-69b83a78be71.avif" alt="">
                        <h3>Nora Fatehi</h3> 
                        <p style="font-size: 10px; color: grey;">Actress</p>
                    </div>
                    <div class="cast-info">     
                        <img src="images/cast/madgoan/pratik-933b6180-3180-11ec-b375-576c4f6c8c68.avif" alt="">
                        <h3>Pratik Gandhi</h3> 
                        <p style="font-size: 10px; color: grey;">Actor</p>
                    </div>
                    <div class="cast-info">
                        <img src="images/cast/madgoan/Avinash-Tiwary.avif" alt="">
                        <h3>Avinash Tiwary</h3> 
                        <p style="font-size: 10px; color: grey;">Actress</p>
                    </div>
                </div>
