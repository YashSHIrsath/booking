        ...
        <div class="display-info" style="padding-top : 100px">
            <div class="intro-info">
                <div class="image-info">
                    <img  src="images/new posters/appu.avif" alt="">
                </div>
                <div class="information">
                    <div class="part1">
                        <h2 id="header">Appu</h2>
                        <p id="cost">220 Rs</p>
                        <p>2h 00m • Animation,Action,Adventure • UA </p>
                        <p> हिन्दी English (2D)</p>
                        <p style="margin: 10px 0px;"><b>Release Date</b> :  1 August, 2024</p>
                        
                        
                    </div>
                    <div class="part2">
                        <a href="https://youtu.be/X10oGrVu-7M?si=4deyDAkRCTRNDNeu"><button id="submit">Watch trailer</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="about-section">
                <h1>About</h1>
                <p>
                    “Appu’s is a story of a determined young elephant, who must brave all odds and cross the ocean, penetrate a deadly forest and discover his true powers to rescue his father from the clutches of notorious poachers. For company he has a talkative abandoned pet dog Tiger and a fugitive little girl Neena.”
                </p>
            </div>
            ...
            <div class="cast-crew">
                ...
                <div class="cast">
                    <div class="cast-info">
                        <img width="120px" src="images/user.avif" alt=""> 
                        <h3>Jasleen Singh</h3> 
                        <p style="font-size: 10px; color: grey;">Voice Actor</p>
                        <p style="font-size: 10px; color: grey;">(Appu)</p>
                    </div>
                    <div class="cast-info">
                        <img width="120px" src="images/user.avif" alt=""> 
                        <h3>Prosenjit Ganguly</h3>  
                        <p style="font-size: 10px; color: grey;">Voice Actor</p>
                        <p style="font-size: 10px; color: grey;">(Elephant)</p>
                    </div>
                    <div class="cast-info">
                        <img width="120px" src="images/user.avif" alt=""> 
                        <h3>Sonal Kaushal</h3>  
                        <p style="font-size: 10px; color: grey;">Voice Actor</p>
                        <p style="font-size: 10px; color: grey;">(Tiger)</p>
                    </div>
