        ...
        <div class="display-info" style="padding-top : 100px">
            <div class="intro-info">
                <div class="image-info">
                    <img  src="images/new posters/Godzu-min-cb740e00-e68a-11ee-b37f-29404991a0ba.avif" alt="">
                </div>
                <div class="information">
                    <div class="part1">
                        <h2 id="header">Godzilla x Kong: The New Empire</h2>
                        <p id="cost">150 Rs</p>
                        <p>1h 57m • Adventure, Fantacy, Action • UA </p>
                        <p> हिन्दी English (3D)</p>
                        <p style="margin: 10px 0px;"><b>Release Date</b> :  30 Apr, 2024</p>
                        
                        
                    </div>
                    <div class="part2">
                        <a href="https://www.youtube.com/watch?v=lV1OOlGwExM"><button id="submit">Watch trailer</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="about-section">
                <h1>About</h1>
                <p>
                    The thrilling fifth film in the Monsterverse series will see the legendary Titans, almighty Kong & Godzilla team up against a world-ending threat so terrifying that neither could survive alone.
                </p>
            </div>
            ...
            <div class="cast-crew">
                ...
                <div class="cast">
                    <div class="cast-info">
                        <img src="images/cast/godzilla/rebecca-hall-7076-11-09-2017-05-49-56-8aeb455b-d8ca-4d47-a9f7-d916130a956e.avif" alt=""> 
                        <h3>Rebecca Hall</h3>  
                        <p style="font-size: 10px; color: grey;">Actress</p>
                    </div>
                    <div class="cast-info">
                        <img src="images/cast/godzilla/Dan-Stevens-d482ccc8-9be9-484d-a056-61a5a10d9d2e.avif" alt="">
                        <h3>Dan Stevens</h3> 
                        <p style="font-size: 10px; color: grey;">Actor</p>
                    </div>
                    <div class="cast-info">     
                        <img src="images/cast/godzilla/Brian-Tyree-Henry-9f98b0fd-1608-431c-9111-ffce9fb6c665.avif" alt="">
                        <h3>Brian Tyree Henry</h3> 
                        <p style="font-size: 10px; color: grey;">Actor</p>
                    </div>
                    <div class="cast-info">
                        <img src="images/cast/godzilla/falen-7a19b940-9335-11ee-8b76-3f1120e9107d.avif" alt="">
                        <h3>Falen Chen</h3> 
                        <p style="font-size: 10px; color: grey;">Actress</p>
                    </div>
                    <div class="cast-info">
                        <img src="images/cast/godzilla/kayle-5a06aa00-9335-11ee-8b76-3f1120e9107d.avif" alt="">
                        <h3>Kayle Hottle</h3> 
                        <p style="font-size: 10px; color: grey;">Actress</p>
                    </div>
                </div>
